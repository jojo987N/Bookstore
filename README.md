...
**Bookstore** The Bookstore is a website similar to the "Awesome Books" website built in the previous module.Use Zeplin design to create a UI.
...
```sh
 cd my-folder
 git clone git@github.com:jojo987N/Bookstore.git
```
### Install
